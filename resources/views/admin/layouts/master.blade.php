...
<![endif]-->
        ...
        <script src="{{ asset('scripts/flot/jquery.flot.min.js') }}"></script>
        <script src="{{ asset('scripts/flot/jquery.flot.pie.min.js') }}"></script>
        <script src="{{ asset('scripts/flot/jquery.flot.resize.min.js') }}"></script>
